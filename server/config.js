...
module.exports = {
  ...
  // =========================================================================
  MANAGER_EMAIL: process.env.MANAGER_EMAIL || 'pawan@gemrishi.com',
  ...
  // =========================================================================
  // To send automated emails from Gmail to pawan@gemrishi.com:
  ...
  SMTP_USER: process.env.SMTP_USER || 'pawan@gemrishi.com', // 👈 ENTER YOUR GMAIL HERE (e.g. 'pawan@gemrishi.com')
  SMTP_PASS: process.env.SMTP_PASS || 'gyze zuur krxg zrgw', // 👈 ENTER YOUR 16-CHAR GOOGLE APP PASSWORD HERE (e.g. 'abcd efgh ijkl mnop')
